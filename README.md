...
**Overview**  
The WhatsApp Chat Analyzer extracts insights from WhatsApp chat data, offering statistics and visualizations to understand conversation patterns using Machine Learning.   
